...
<body class="h-full font-sans antialiased">
    <main class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        {{-- Komponen utama yang diatur oleh AlpineJS --}}
        <div x-data="{ isLogin: true }"
            ...
            <div class="absolute top-0 left-0 h-full w-full md:w-1/2 bg-blue-600 transition-transform duration-700 ease-in-out z-20"
                :class="{ 'md:translate-x-0': !isLogin, 'md:translate-x-full': isLogin }">
            ...
            <div class="relative grid grid-cols-1 md:grid-cols-2 col-span-2">
                ...
                {{-- FORM REGISTRASI --}}
                <div class="p-8 sm:p-12">
                    <h2 class="text-3xl font-bold text-slate-900">Registration</h2>
